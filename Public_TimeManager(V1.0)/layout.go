...
func (l *nyLayout) Layout(_ []fyne.CanvasObject, size fyne.Size) {
	...
	l.projectIDLabel.Move(fyne.NewPos(size.Width-sideWidth+14, topHeight+140))
	...
	//l.dividers[1].Resize(fyne.NewSize(dividerThickness-120, size.Height-topHeight))
